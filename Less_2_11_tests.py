...
class MyTestCase(unittest.TestCase):
    def test_1_Simple_Way(self):
        ...
        Way = TestGraph.BreadthFirstSearch(0, 1)
    ...
    def test_2_No_Way(self):
        ...
        self.assertEqual(TestGraph.BreadthFirstSearch(0, 8), [])   # проверка, результат - пустой список
    ...
    def test_3_Is_Way(self):
        ...
        Way = TestGraph.BreadthFirstSearch(0, 8)
    ...
    def test_4_Is_Way_2(self):
        ...
        Way = TestGraph.BreadthFirstSearch(2, 8)                    # проводим повторный поиск чтоб проверить как обнуляется все внутри
