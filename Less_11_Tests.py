...
class MyTestCase(unittest.TestCase):
    ...
    def test_1_put_and_size (self):
        ...
        for i in range(N//100):               # Снова добавляем чисел (чтоб повторялись)
            Set1.put(i)
    ...
    def test_3_intersection(self):
        ...
        self.assertEqual(Set1.size(), N - M)    # Проверка по размеру множества (равно N-M) 
        for i in range (M, N):
            self.assertTrue(Set1.get(i))        # Проверка по содержимому (содержит числа от М до N)
    ...
    def test_4_union(self):
        ...
        for i in range(M, M+N, 1):
            Set2.put(i)
        Set1.union(Set2)
        self.assertEqual(Set1.size(), N + M)    # Проверка по размеру множества
        for i in range (M+N):
            self.assertTrue(Set1.get(i))        # Проверка по содержимому (содержит числа от 0 до N + M)
    ...
    def test_4_1_union_with_empty(self):
        ...
        for i in range(N):
            Set1.put(i)
        Set1.union(Set2)
        self.assertEqual(Set1.size(), N)        # Проверка по размеру множества (не изменилось)
    ...
    def test_5_difference(self):
        ...
        self.assertEqual(Set1.size(), M)    # Проверка по размеру множества (равно 70) 
        for i in range (M):
            self.assertTrue(Set1.get(i))        # Проверка по содержимому (содержит числа от 0 до M)
